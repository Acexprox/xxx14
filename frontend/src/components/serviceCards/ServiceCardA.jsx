    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-[1fr_1.05fr] gap-0 px-6 mt-4" dir="rtl">
        ...
        >
          ...
          {/* زر المزيد الفاخر المنحوت - فوق الحاوية */}
          <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-20">
            <button
              type="button"
              data-testid="service-card-a-cta-button"
              className="group relative inline-flex items-center gap-1.5 rounded-full px-4 py-1.5 text-[11px] font-extrabold tracking-wider uppercase transition-all duration-200 ease-out"
              style={{
                color: "#3F2D17",
                background: "linear-gradient(180deg, #F8E8CD 0%, #EDD9BA 25%, #E3CCA5 50%, #D9BF91 75%, #D0B484 100%)",
                boxShadow:
                  "inset 0 1px 0 rgba(255,255,255,0.95), inset 0 2px 3px rgba(255,255,255,0.55), inset 0 -1px 3px rgba(120,53,15,0.35), inset 0 -2px 5px rgba(100,40,10,0.25), 0 4px 12px rgba(120,53,15,0.30), 0 2px 6px rgba(120,53,15,0.20), 0 1px 3px rgba(80,30,5,0.40)",
                border: "1px solid rgba(160,100,35,0.65)",
                textShadow: "0 1px 1px rgba(255,255,255,0.75), 0 -0.5px 1px rgba(120,53,15,0.25)",
                letterSpacing: "0.05em",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "linear-gradient(180deg, #FDF3DB 0%, #F2E3C5 25%, #E8D5AE 50%, #DEC799 75%, #D6BC88 100%)";
                e.currentTarget.style.boxShadow = "inset 0 1px 0 rgba(255,255,255,1), inset 0 2px 4px rgba(255,255,255,0.65), inset 0 -1px 3px rgba(120,53,15,0.40), inset 0 -2px 6px rgba(100,40,10,0.30), 0 6px 16px rgba(120,53,15,0.40), 0 3px 8px rgba(120,53,15,0.30), 0 1px 4px rgba(80,30,5,0.50)";
                e.currentTarget.style.transform = "translateY(-1px) scale(1.02)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "linear-gradient(180deg, #F8E8CD 0%, #EDD9BA 25%, #E3CCA5 50%, #D9BF91 75%, #D0B484 100%)";
                e.currentTarget.style.boxShadow = "inset 0 1px 0 rgba(255,255,255,0.95), inset 0 2px 3px rgba(255,255,255,0.55), inset 0 -1px 3px rgba(120,53,15,0.35), inset 0 -2px 5px rgba(100,40,10,0.25), 0 4px 12px rgba(120,53,15,0.30), 0 2px 6px rgba(120,53,15,0.20), 0 1px 3px rgba(80,30,5,0.40)";
                e.currentTarget.style.transform = "translateY(0) scale(1)";
              }}
              onMouseDown={(e) => {
                e.currentTarget.style.background = "linear-gradient(180deg, #D9BF91 0%, #D3B788 25%, #CDAF7F 50%, #C7A776 75%, #C19F6D 100%)";
                e.currentTarget.style.boxShadow = "inset 0 3px 6px rgba(100,40,10,0.50), inset 0 5px 10px rgba(80,30,5,0.40), inset 0 -1px 1px rgba(255,255,255,0.35), inset 0 1px 2px rgba(255,255,255,0.25), 0 1px 3px rgba(120,53,15,0.25), 0 0.5px 2px rgba(80,30,5,0.30)";
                e.currentTarget.style.transform = "translateY(2px) scale(0.96)";
                e.currentTarget.style.textShadow = "0 0.5px 1px rgba(255,255,255,0.55), 0 -0.5px 1px rgba(120,53,15,0.35)";
              }}
              onMouseUp={(e) => {
                e.currentTarget.style.background = "linear-gradient(180deg, #FDF3DB 0%, #F2E3C5 25%, #E8D5AE 50%, #DEC799 75%, #D6BC88 100%)";
                e.currentTarget.style.boxShadow = "inset 0 1px 0 rgba(255,255,255,1), inset 0 2px 4px rgba(255,255,255,0.65), inset 0 -1px 3px rgba(120,53,15,0.40), inset 0 -2px 6px rgba(100,40,10,0.30), 0 6px 16px rgba(120,53,15,0.40), 0 3px 8px rgba(120,53,15,0.30), 0 1px 4px rgba(80,30,5,0.50)";
                e.currentTarget.style.transform = "translateY(-1px) scale(1.02)";
                e.currentTarget.style.textShadow = "0 1px 1px rgba(255,255,255,0.75), 0 -0.5px 1px rgba(120,53,15,0.25)";
              }}
            >
              {/* طبقة نسيج محفورة دقيقة */}
              <span
                aria-hidden
                className="absolute inset-0 rounded-full pointer-events-none"
                style={{
                  background: "repeating-linear-gradient(90deg, rgba(255,255,255,0.05) 0px, rgba(255,255,255,0.05) 1px, transparent 1px, transparent 2px), repeating-linear-gradient(180deg, rgba(0,0,0,0.03) 0px, rgba(0,0,0,0.03) 1px, transparent 1px, transparent 2px)",
                  opacity: 0.25,
              ...
              <span
                aria-hidden
                className="absolute top-0 left-2 right-2 h-1/3 rounded-full pointer-events-none"
                style={{
                  background: "radial-gradient(ellipse at center top, rgba(255,255,255,0.55), transparent 70%)",
                  filter: "blur(1.5px)",
                  opacity: 0.75,
                }}
              />
